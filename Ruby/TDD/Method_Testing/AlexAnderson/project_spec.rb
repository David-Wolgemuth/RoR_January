...
#this line enacts the Rspec library and calls the describe method that takes in lsthe class Project, when doing so it expects to do something
RSpec.describe Project do
  ...
  it 'has a getter and setter for name attribute' do
    ...
    expect(project.get_num_of_team_members).to eq(1)
  end
end
